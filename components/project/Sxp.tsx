...
export default function Sxp() {
  return (
    <div className="h-screen relative container mx-auto xl:max-w-5xl  py-20 w-full">
      {/* <div className="text-base font-sans mb-10 ms-10 flex items-center w-full ">
